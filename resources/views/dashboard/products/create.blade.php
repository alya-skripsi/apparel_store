            ...
            <form action="/dashboard/products" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('stock') is-invalid @enderror" id="stock" name="stock" value="1" >
                        @error('stock')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" onchange="previewImages()">
                        @error('image')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
